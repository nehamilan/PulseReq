...
import { RequisitionProvider } from "@/lib/requisition-store";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "5Zq1ru_sbygQuaLU6aQsVs1F4Siy9cLlP8qiIjT2SyM" },
      ...
      { property: "og:title", content: "PulseReq — Paperless diagnostic requisitions" },
      {
        ...
        content:
          "Tokenized, paperless lab and imaging requisitions between clinics and diagnostic centres.",
      },
